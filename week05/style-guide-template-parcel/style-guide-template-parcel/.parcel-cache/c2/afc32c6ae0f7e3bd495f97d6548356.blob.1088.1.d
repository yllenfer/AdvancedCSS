...
@media only screen and (min-width: 1024px) {
  ...
  .cd-main-nav li a.selected {
    color: #005678;
    box-shadow: 0 2px 0 #ff2a6d;
  }
  .cd-main-nav li a:hover {
    color: #05d9e8;
    box-shadow: 2px 2px 8px #05d9e8;
    text-shadow: 0 0 8px #005678;
  }
}
...
.nav-is-visible .cd-nav-trigger span {
  ...
  background-color: rgba(1, 1, 43, 0);
}
...
h1,
h2 {
  font-family: "Orbitron", Arial, Helvetica, sans-serif, serif;
  color: #d1f7ff;
}
...
.btn.btn-outline {
  ...
  box-shadow: inset 0 0 0 1px #005678;
}
